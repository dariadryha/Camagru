                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                        ...
                        <tr>
                            <td bgcolor="#47a2ea" align="center" style="border-radius:3px;padding: 10px 16px 14px 16px">
                                <a href="$link" style="color: #ffffff;text-decoration:none;display:block"><span style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-weight: bold">Activate account</span></a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
